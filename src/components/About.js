        ...
        <div>
            ...
            <div className={'bio'}>
                ...
                <div className={'light-blue'}>
                    <a className={'new-thing'} target="_blank" href={'https://apps.apple.com/us/app/id1531592573'}>
                ...
                <a target="_blank" href={'https://www.instagram.com/art.by.gwen/'}> Instagram </a>
                <a target="_blank" href={'https://github.com/gwenfriedman'}> Github </a>
                <a target="_blank" href={'https://www.linkedin.com/in/gwendolyn-friedman/'}> LinkedIn </a>
